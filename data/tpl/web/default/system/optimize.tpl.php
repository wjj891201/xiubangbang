...
<div class="clearfix">
	...
	<br />
	<div class="alert we7-page-alert">
		<p><i class="wi wi-info-sign"></i> 开启后，可以有效的缓存低频的变动数据，提升系统效率。<p>
		<p><i class="wi wi-info-sign"></i> 此项要求系统必须开启memcache缓存<p>
	</div>
	<div class="panel we7-panel">
		<div class="panel-heading">SQL缓存</div>
			<table class="table we7-table table-hover site-list">
				<tr>
					<td width="200">状态</td>
					<td class="text-left">
						<?php  if(!empty($extensions['memcache']['status']) && !empty($setting['memcache']['sql'])) { ?>
							<span class="label label-success">已开启</span>
						<?php  } else { ?>
							<span class="label label-danger">未开启</span>
						<?php  } ?>
