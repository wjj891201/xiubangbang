		...
		<tr ng-if="version_exist" ng-repeat="version in wxapp_version_lists">
			...
			<td class="text-right">
				<div class="link-group">
					...
					<a href="./index.php?c=wxapp&a=post&do=post&design_method={{version.design_method}}&uniacid={{version.uniacid}}&version_id={{version.id}}&create_type={{version.type}}" >修改</a>
