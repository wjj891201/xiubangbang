            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <button type="button" class="btn btn-primary btn-xs btn-edit" data-toggle="modal" data-target="#myModal" picid="<?php  echo $item['picid'];?>">编辑</button> 
                        <button type="button" class="btn btn-danger btn-xs btn-del" picid="<?php  echo $item['picid'];?>">删除</button>
                    </td>
                </tr>
                <?php  } } ?>
            </tbody>
